...
export default function LaptopHistory() {
  ...
  const filteredLaptops = laptops.filter((laptop) => {
    ...
    const assignedToMatch =
      !assignedTo || (laptop.assignedTo?.employeeName || 'No employee assigned').toLowerCase().includes(assignedTo.toLowerCase().trim());
        ...
        <div className="p-4 sm:ml-64">
          <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <div className="p-4">
              ...
              <h3 className="text-center font-bold" style={{ color: "#FF735C" }}>Laptop History / Update Laptop 📑</h3>
            ...
            <dialog id="my_modal_4" className="modal">
              <div className="modal-box w-11/12 max-w-5xl">
                <h4 className="text-center font-bold" style={{ color: "#FF735C" }}>Update Laptop Details</h4>
