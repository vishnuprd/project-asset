...
export default function Addlaptop() {
  ...
  const Inputform = [
    ...
    { id: 15, name: "windowSoftware", label: "Window Software Installed", options: ["Yes", "No"], required: true },
    { id: 16, name: "antivirus", label: "Anti Virus", options: ["Installed", "Not Installed"], required: true },
    { id: 17, name: "msOffice", label: "Ms-Office", options: ["Yes", "No", "WPS-Office"], required: true },
  ];
